...
public class PropertyManagerApacheImpl implements PropertyManager, ConfigurationErrorListener {
	 ...
	 * @throws PpkException
	 */
	public PropertyManagerApacheImpl(String basePath, String masterConfigurationFile) throws PpkException {
...
//						+ nameFile);
	 ...
	 */
	public String getProperty(String value) throws PpkException {
		try {
			if (value != null) {
	 ...
	 *         not exists
	 */
	public List<String> getPropertyAsList(String value) throws PpkException {
		try {
	 ...
	 * 
	 */
	public boolean AddListener(PropertyManagerChangeListener pml) throws PpkException {
		try {
	 ...
	 * 
	 */
	public boolean removeListener(PropertyManagerChangeListener pml) throws PpkException {
		try {
	 ...
	 * 
	 */
	public void print() throws PpkException {
		try {
